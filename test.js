...
import { StyleSheet, Easing,Text,TouchableOpacity, View, Dimensions, Image, Animated, PanResponder,TouchableWithoutFeedback } from 'react-native';
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={styles.buttonsWrapper}>
            ...
            {/* <TouchableOpacity style={styles.bottomButton}>
             ...
             <TouchableOpacity style={{width:130,height:130}} onPress={this.animationStart}>
             <LottieView style={{backgroundColor:"red"}} source={require('@assets/animation2.json')} progress={this.state.progress} />
             </TouchableOpacity>
        </View>
      </View>
